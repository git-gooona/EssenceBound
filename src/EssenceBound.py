...
#
#abrupt transition to battle from map
...
# multi attack bleeding would be cool
#######################################################################
...
def onAppStart(app):
    ...
    ###Monster Actions
    app.questX=540 # acts as a coord point for text on the quest npc screen. should be replaced with quest_base_x amd quest_base_y
    app.questY=320

    app.enemyX1 = 749 # acts as coords for enemy drawn. i think we store this data with the enemy template? not sure
    app.enemyY1 = 169
    app.enemyX2 = 669
    app.enemyY2 = 409
    
    app.currentCards += 1 # should probably keep track of that

    ###Position Variables
    app.deckX=1200 # deck coords. should be saved as deck_base_x and deck_base_y
    app.deckY=140
    
    app.discardX=1200 # discard_base_x which can be defined based off deck_base_x
    app.discardY=240
    
    app.handX=600 # hand coord
    app.handY=450
    
    app.UIX=0 # for various UI features
    app.UIY=0
    
    app.mX = 200 # start menu buttons coordinates - graphical
    app.mY = 200
    
    app.LX1 = 1050 # start menu button coordinates - labels
    app.LY1 = 230
    
    app.RW1 = 400 # more start screen bullshit
    app.RH1 = 75
    
    app.EX1 = 80 # exit button coords bottom left of settings
    app.EY1 = 520
    
    app.bw = 60 #coords for the card options
    app.bh = 90
    app.by = 450
    
    app.bx1=600 # i think this handles each cards coord logic? for like hits_shape
    app.bx2=670
    app.bx3=740
    app.bx4=810
    app.bx5=880
    ...
    app.mapOriginX = 700 #bullshit map data
    app.mapOriginY = 280
    
    app.pX = app.mapOriginX + 60 # player coords for the map
...
def hitsShape(mouse_x, mouse_y, starting_x, width, starting_y, height):
    if mouse_x in range(starting_x, starting_x + width) and mouse_y in range(starting_y, starting_y + height):
        return True
